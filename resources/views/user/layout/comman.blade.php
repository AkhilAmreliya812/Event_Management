    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-info">
        <div class="container-fluid">
            <a class="navbar-brand text-dark" href="{{ route('home') }}">
                <img src="http://localhost/event_manager/public/logo/logo.png" alt="logo/logo.png" height="50px"
                    width="50px"> Advanture
            </a>
        ...
        <div class="container">
            <div class="row gy-4">
                ...
                <div class="col-md-4">
                    ...
                    <p class="mb-1">📧 <a href="mailto:info@gmail.com"
                            class="text-dark text-decoration-none">info@gmail.com</a></p>
                    <p class="mb-0">📞 +91 11111 11111</p>
                </div>
            </div>
            <hr class="border-secondary my-3">
            <div class="text-center">
                <p class="mb-0">&copy; Event Manager 2025. All Rights Reserved</p>
            </div>
        </div>
    </footer>
</body>
